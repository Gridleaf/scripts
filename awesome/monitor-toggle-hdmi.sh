...
if [ "$HDMI_ON" = false ] && [ "$DP_ON" = false ]; then
	xrandr --output eDP-1 --primary --mode 1920x1080 --rate 60.01 --pos 0x-110 --output HDMI-1 --mode 2560x1440 --rate 143.91 --pos 1920x0 --output DP-2 --off
	...
	xrandr --output eDP-1 --primary --mode 1920x1080 --rate 60.01 --pos 0x-110 --output HDMI-1 --off --output DP-2 --mode 1920x1080 --rate 74.97 --rotate left --pos 1920x-220
fi
